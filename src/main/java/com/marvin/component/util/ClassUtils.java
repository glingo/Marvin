...
public abstract class ClassUtils {
    ...
    public static Member findMember(Class clazz, String attributeName, Class[] argumentTypes) {
        Member result = null;
        ...
        result = ClassUtils.getMethodIfAvailable(clazz, "get" + attributeName, argumentTypes);

        // check is method
        if (result == null) {
            result = ClassUtils.getMethodIfAvailable(clazz, "is" + attributeCapitalized, argumentTypes);
        }

        // check has method
        if (result == null) {
            result = ClassUtils.getMethodIfAvailable(clazz, "has" + attributeCapitalized, argumentTypes);
        }

        // check if attribute is a public method
        if (result == null) {
            result = ClassUtils.getMethodIfAvailable(clazz, attributeName, argumentTypes);
        }
